...
class Command {
    constructor() {
        this.name = "wasted";
        this.description = "Generates a wasted overlay for a given avatar";
        this.attributes = {
            unlisted: false,
            admin: false,
            exclusive: true,
    ...
    async invoke(message, args) {
        ...
        try {
            const response = await axios.get(`https://some-random-api.com/canvas/overlay/wasted?avatar=${avatar}`, {
