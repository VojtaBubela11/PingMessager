...
class Command {
    constructor() {
        this.name = "jail";
        this.description = "Generates a jail overlay for a given avatar";
        this.attributes = {
            unlisted: false,
            admin: false,
            exclusive: true,
    ...
    async invoke(message, args) {
        ...
        try {
            const response = await axios.get(`https://some-random-api.com/canvas/overlay/jail?avatar=${avatar}`, {
