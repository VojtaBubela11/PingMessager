...
class Command {
    constructor() {
        this.name = "passed";
        this.description = "Generates a mission passed overlay for a given avatar";
        this.attributes = {
            unlisted: false,
            admin: false,
            exclusive: true,
    ...
    async invoke(message, args) {
        ...
        try {
            const response = await axios.get(`https://some-random-api.com/canvas/overlay/passed?avatar=${avatar}`, {
