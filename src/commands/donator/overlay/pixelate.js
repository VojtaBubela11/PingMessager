...
class Command {
    constructor() {
        this.name = "pixelate";
        this.description = "Generates a pixelate overlay for a given avatar";
        this.attributes = {
            unlisted: false,
            admin: false,
            exclusive: true,
    ...
    async invoke(message, args) {
        ...
        try {
            const response = await axios.get(`https://some-random-api.com/canvas/misc/pixelate?avatar=${avatar}`, {
